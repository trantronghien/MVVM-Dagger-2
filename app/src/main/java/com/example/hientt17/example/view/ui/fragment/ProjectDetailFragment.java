...
public class ProjectDetailFragment extends LifecycleFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        detailViewModel.getDetailRepository(projectUser , projectID );
    ...
    public static ProjectDetailFragment forProject(String projectID, String UserName) {
